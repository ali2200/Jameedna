                  ...
                  <div className="flex items-start space-x-6 rtl:space-x-reverse">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground leading-relaxed text-base" data-testid="text-vision">
                        {language === 'ar'
                          ? 'في الفرسان، لدينا الإلتزام راسخ بالجودة المثالية. نحن نؤمن بالإستفادة من وفرة وغنى الأردن، حيث يتم التعامل مع منتجاتنا الغذائية بأقصى درجات العناية والإهتمام للحفاظ على نضارتها وخصائصها الأصيلة. الفرسان شركة تمتلك خبرة تزيد عن عشرين عامًا في صناعة الأغذية. بدأت كعمل عائلي، حيث نشأت الإدارة العليا داخل هذا المجال وطبقت معرفتها من أجل تحقيق منتجات عالية الجودة. كرائد قوي وناجح في الأردن، مع تاريخ عميق في السوق وقاعدة عملاء واسعة، إستطاع فريق الفرسان بناء حضور وسمعة قوية محليًا ودوليًا. يتم التعامل مع إقتناء ومعالجة المواد الخام لإنشاء منتجات غذائية عالية الجودة بأقصى قدر من الإهتمام والنزاهة فيما يتعلق بالنظافة والحفاظ على جودتها الطبيعية وطعمها وأصالتها.'
