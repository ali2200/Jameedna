              ...
              <div className="space-y-4 animate-fade-in-up">
                ...
                <div className="space-y-4 text-base text-muted-foreground leading-relaxed">
                  <p data-testid="text-story-intro">
                    {language === 'ar' 
                      ? <>في <span className="text-primary font-bold">الفرسان</span>، لدينا الإلتزام راسخ بالجودة المثالية. نحن نؤمن بالإستفادة من وفرة وغنى الأردن، حيث يتم التعامل مع منتجاتنا الغذائية بأقصى درجات العناية والإهتمام للحفاظ على نضارتها وخصائصها الأصيلة.</>
                  ...
                  <p data-testid="text-story-1">
                    {language === 'ar'
                      ? <><span className="text-primary font-bold">الفرسان</span> شركة تمتلك خبرة تزيد عن عشرين عامًا في صناعة الأغذية. بدأت كعمل عائلي، حيث نشأت الإدارة العليا داخل هذا المجال وطبقت معرفتها من أجل تحقيق منتجات عالية الجودة.</>
                  ...
                  <p data-testid="text-story-3">
                    {language === 'ar'
                      ? 'يتم التعامل مع إقتناء ومعالجة المواد الخام لإنشاء منتجات غذائية عالية الجودة بأقصى قدر من الإهتمام والنزاهة فيما يتعلق بالنظافة والحفاظ على جودتها الطبيعية وطعمها وأصالتها.'
