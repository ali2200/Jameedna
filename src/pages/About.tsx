                  ...
                  <div className="flex items-start space-x-6 rtl:space-x-reverse">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground leading-relaxed text-base" data-testid="text-vision">
                        {language === 'ar'
                          ? <>في <span className="text-primary font-bold">الفرسان</span>، لدينا الإلتزام راسخ بالجودة المثالية. نحن نؤمن بالإستفادة من وفرة وغنى الأردن، حيث يتم التعامل مع منتجاتنا الغذائية بأقصى درجات العناية والإهتمام للحفاظ على نضارتها وخصائصها الأصيلة. <span className="text-primary font-bold">الفرسان</span> شركة تمتلك خبرة تزيد عن عشرين عامًا في صناعة الأغذية. بدأت كعمل عائلي، حيث نشأت الإدارة العليا داخل هذا المجال وطبقت معرفتها من أجل تحقيق منتجات عالية الجودة. كرائد قوي وناجح في الأردن، مع تاريخ عميق في السوق وقاعدة عملاء واسعة، إستطاع فريق <span className="text-primary font-bold">الفرسان</span> بناء حضور وسمعة قوية محليًا ودوليًا. يتم التعامل مع إقتناء ومعالجة المواد الخام لإنشاء منتجات غذائية عالية الجودة بأقصى قدر من الإهتمام والنزاهة فيما يتعلق بالنظافة والحفاظ على جودتها الطبيعية وطعمها وأصالتها.</>
                          : <><span className="text-primary font-bold">ALFURSAN</span> have a strong commitment to impeccable quality. We are of the mindset of taking advantage of the abundance and richness of Jordan, where our food products are handled with utmost care and attention to maintain their freshness and authentic traits. <span className="text-primary font-bold">ALFURSAN</span> is a company with over twenty years of experience within the food industry. It started off as a family business, with the top management growing up within the field and implementing their knowledge in order to attain top-quality products. A solid, successful flagship in Jordan, with a deep history in the market as well as an extensive client base, has allowed the <span className="text-primary font-bold">Al Fursan</span> team to build a strong presence and reputation locally and internationally. The acquisition and processing of raw materials to create high-quality food products are handled with the utmost attention and integrity in regards to hygiene and conservancy of their natural quality, taste, and authenticity.</>}
                      </p>
                    </div>
                  </div>
                </CardContent>
