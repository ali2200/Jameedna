...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'products.jameednaZaman.ingredients': '100% جميد نقي من أحجار الجميد (حليب غنم طازج مبستر، ملح، بادئ)، ماء، بهارات، ملح.',
    'products.jameednaZaman.features': 'جميد مغسول من أحجار الجميد النقية 100% بأعلى معايير النظافة، محلول بماء معقم، مطبوخ ومعبأ في عبوات كومبي بلوك، محكم الإغلاق.',
    ...
    'products.jameedBadawya.ingredients': '100% جميد نقي من أحجار الجميد (حليب غنم طازج مبستر، ملح، بادئ)، ماء، بهارات، ملح.',
    'products.jameedBadawya.features': 'جميد مغسول من أحجار الجميد النقية 100% بأعلى معايير النظافة، محلول بماء معقم، مطبوخ ومعبأ في عبوات كومبي بلوك، محكم الإغلاق.',
    ...
    'products.feature.packaging.desc': 'تقنية كومبي بلوك المتطورة للحفاظ على الطعم والقيمة الغذائية',
  ...
  en: {
    ...
    'products.jameednaZaman.ingredients': '100% pure Jameed stones (fresh pasteurized sheep milk, salt, starter culture), water, spices, salt.',
    'products.jameednaZaman.features': '100% pure Jameed stones with the highest hygiene standards, washed and free from all impurities, dissolved in sterilized water, cooked and packaged in combi block packaging.',
    ...
    'products.jameedBadawya.ingredients': '100% pure Jameed stones (fresh pasteurized sheep milk, salt, starter culture), water, spices, salt.',
    'products.jameedBadawya.features': '100% pure Jameed stones with the highest hygiene standards, washed and free from all impurities, dissolved in sterilized water, cooked and packaged in combi block packaging.',
    ...
    'products.feature.packaging.desc': 'Advanced Combi Blocks technology to preserve taste and nutritional value',
